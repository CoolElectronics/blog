...
Anyway, here's the schematic for the rom chip used in most Chromebooks. The pin that has the text "WP" is what controls whether write-protection is enabled on the chip itself.
  If you look very closely at the board, you might even be able to see the trace running from the CR50 to the write-protection pin. When the pin is connected to a power line, write protection is on. When the pin is connected to VCC, write protection is off.

Can you see where I'm going with this?

Fortunately for us, if you were to short them together with... oh, let's say a piece of tin foil and some tape...
![an image showing the SOIC-8 chip and the pins you need to short to disable WP](./breaking/shorting.png)
...
- Rafflesia (@mercuryworkshop) - theorizing about pulling the WP line to VCC
